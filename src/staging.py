...
def ensure_local_file(
    ...
    *,
    ...
    uri_key = hashlib.sha1(loc.s3_uri().encode("utf-8")).hexdigest()[:16]
    basename = os.path.basename(loc.raw) or "object"
    local_path = os.path.join(cache_dir, f"{uri_key}__{basename}")
